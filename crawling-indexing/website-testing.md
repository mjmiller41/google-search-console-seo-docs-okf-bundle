---
type: Reference
title: Minimize A/B testing impact in Google Search
description: Discover how to ensure A/B testing has minimal impact on Search by following website testing best practices for AB testing, multivariate testing, and more.
resource: https://developers.google.com/search/docs/crawling-indexing/website-testing
tags:
- google-search
- documentation
- crawling-indexing
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/crawling-indexing/website-testing](https://developers.google.com/search/docs/crawling-indexing/website-testing). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2025-12-10.[^google-website-testing]
...
[^google-website-testing]: Google Search Central (2025). "Minimize A/B testing impact in Google Search". *Google for Developers*. https://developers.google.com/search/docs/crawling-indexing/website-testing. Retrieved 2026-09-01.
