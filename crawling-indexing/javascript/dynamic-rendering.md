...
description: Dynamic rendering was a workaround for websites experiencing issues with JavaScript-powered content.
resource: https://developers.google.com/search/docs/crawling-indexing/javascript/dynamic-rendering
tags:
- google-search
- documentation
- crawling-indexing
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/crawling-indexing/javascript/dynamic-rendering](https://developers.google.com/search/docs/crawling-indexing/javascript/dynamic-rendering). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2025-12-10.[^google-dynamic-rendering]
...
Googlebot generally doesn't consider dynamic rendering as [cloaking](/essentials/spam-policies.md). As long as your dynamic rendering produces similar content, Googlebot won't view dynamic rendering as cloaking.

When you're setting up dynamic rendering, your site may produce error pages. Googlebot doesn't consider these error pages as cloaking and [treats the error as any other error page](/crawling-indexing/javascript/javascript-seo-basics.md).
...
[^google-dynamic-rendering]: Google Search Central (2025). "Dynamic rendering as a workaround". *Google for Developers*. https://developers.google.com/search/docs/crawling-indexing/javascript/dynamic-rendering. Retrieved 2026-09-01.
