---
type: Reference
title: Validate your AMP content
description: Explore this guide to learn how to validate AMP content, how to fix AMP errors, and for more AMP resources.
resource: https://developers.google.com/search/docs/crawling-indexing/amp/validate-amp
tags:
- google-search
- documentation
- crawling-indexing
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/crawling-indexing/amp/validate-amp](https://developers.google.com/search/docs/crawling-indexing/amp/validate-amp). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2026-07-01.[^google-validate-amp]

After you've [created AMP content](https://developers.google.com/search/docs/guides/enhance-amp), here are some ways to validate your AMP content:
...
3.  Make your AMP content accessible to Googlebot:
    ...
    - Remove all robots `meta` tags and `X-Robots-Tag` HTTP headers from your canonical and AMP content. For more information, see [Robots `meta` tag and `X-Robots-Tag` HTTP header specifications](/crawling-indexing/robots-meta-tag.md).
...
[^google-validate-amp]: Google Search Central (2026). "Validate your AMP content". *Google for Developers*. https://developers.google.com/search/docs/crawling-indexing/amp/validate-amp. Retrieved 2026-09-01.
