---
type: Reference
title: Keep redacted information out of Google Search
description: Learn best practices for how to redact information from documents that you don't want to be indexed and made discoverable via Google Search.
resource: https://developers.google.com/search/docs/crawling-indexing/keep-redacted-information-out
tags:
- google-search
- documentation
- crawling-indexing
...
sources:
- id: google-keep-redacted-information-out
  resource: https://developers.google.com/search/docs/crawling-indexing/keep-redacted-information-out
  title: Keep redacted information out of Google Search
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/crawling-indexing/keep-redacted-information-out](https://developers.google.com/search/docs/crawling-indexing/keep-redacted-information-out). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2025-12-10.[^google-keep-redacted-information-out]
...
- Consider information in the URL or file name itself. Even if a part of a website is [blocked by robots.txt](/crawling-indexing/robots/intro.md), the URLs may be indexed in search (without their content). Use hashes in URL parameters instead of email addresses or names.
- Consider using authentication to limit access to the redacted content. Serve the resulting login page with a [`noindex` robots `meta` tag](/crawling-indexing/block-indexing.md) to block indexing.
...
[^google-keep-redacted-information-out]: Google Search Central (2025). "Keep redacted information out of Google Search". *Google for Developers*. https://developers.google.com/search/docs/crawling-indexing/keep-redacted-information-out. Retrieved 2026-09-01.
