...
description: A sitemap provides information that helps Google more intelligently crawl your site. Discover how a sitemap works and determine if you need one.
resource: https://developers.google.com/search/docs/crawling-indexing/sitemaps/overview
tags:
- google-search
- documentation
- crawling-indexing
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/crawling-indexing/sitemaps/overview](https://developers.google.com/search/docs/crawling-indexing/sitemaps/overview). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2025-12-10.[^google-overview]
...
You can use a sitemap to provide information about specific types of content on your pages, including [video](/crawling-indexing/sitemaps/video-sitemaps.md), [image](/crawling-indexing/sitemaps/image-sitemaps.md), and [news](/crawling-indexing/sitemaps/news-sitemap.md) content. For example:
...
> If you're using a CMS such as WordPress, Wix, or Blogger, it's likely that your CMS has already [made a sitemap available to search engines](/crawling-indexing/sitemaps/build-sitemap.md) and you don't have to do anything.
...
- **Your site is large.** Generally, on large sites it's more difficult to make sure that every page is linked by at least one other page on the site. As a result, it's more likely [Googlebot](/crawling-indexing/googlebot.md) might not discover some of your new pages.
...
If you decided that you need a sitemap, [learn more about how to create one](/crawling-indexing/sitemaps/build-sitemap.md).

# References & Citations

[^google-overview]: Google Search Central (2025). "Learn about sitemaps". *Google for Developers*. https://developers.google.com/search/docs/crawling-indexing/sitemaps/overview. Retrieved 2026-09-01.
