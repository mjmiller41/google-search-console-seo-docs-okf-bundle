...
<td>
<code>Storebot-Google</code> follows group 2, because there is no specific
...
<td>
        When crawling images, <code>googlebot-news</code> follows group 1.
        <code>googlebot-news</code> doesn't crawl the images for Google Images, so it only
        follows group 1.
      </td>
</tr>
<tr>
...
<td>
        ...
        <code>googlebot-news</code> follow group 2. Even if there is an entry for a related
