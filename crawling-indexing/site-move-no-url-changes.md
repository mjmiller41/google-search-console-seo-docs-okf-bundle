...
description: Discover how to minimize the impact on your Google Search performance when transferring your site's hosting infrastructure without changing your URLs.
resource: https://developers.google.com/search/docs/crawling-indexing/site-move-no-url-changes
tags:
- google-search
- documentation
- crawling-indexing
...
sources:
- id: google-site-move-no-url-changes
  resource: https://developers.google.com/search/docs/crawling-indexing/site-move-no-url-changes
  title: Changing your hosting
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/crawling-indexing/site-move-no-url-changes](https://developers.google.com/search/docs/crawling-indexing/site-move-no-url-changes). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2025-12-10.[^google-site-move-no-url-changes]
...
> **Changing the URLs?** If you're making visible URL changes, start with [Site moves with URL changes](/crawling-indexing/site-move-with-url-changes.md).

## Overview

1.  **[Prepare the new hosting infrastructure](https://developers.google.com/search/docs/crawling-indexing/site-move-no-url-changes/#hosting-infrastructure)**. Upload your content to the new servers or configure your CDN and your origin servers, and test it.
2.  **[Start the site move](https://developers.google.com/search/docs/crawling-indexing/site-move-no-url-changes/#start-site-move)**. Change the DNS settings of your domain name to point to the new hosting infrastructure. This step is the actual site move step that starts the process of sending your traffic to the new infrastructure.
3.  **[Monitor traffic](https://developers.google.com/search/docs/crawling-indexing/site-move-no-url-changes/#monitor)**. Keep tabs on the traffic served by the old and new hosting.
4.  **[Shut down](https://developers.google.com/search/docs/crawling-indexing/site-move-no-url-changes/#shut-down-old-hosting)**. Shut down the old hosting infrastructure when you're confident that all users, including Googlebot, are receiving content correctly from the new infrastructure and no one is using the old infrastructure.
...
- **Allow for public testing** with a temporary hostname for your new infrastructure (like `beta.example.com`) so you can test accessibility by browsers. A temporary hostname can help you test whether Googlebot can reach your site or not. To prevent accidentally letting the test site get indexed, add the [`noindex` `robots` rule](/crawling-indexing/block-indexing.md) to the HTML or the HTTP headers of your pages.

### Check that Googlebot is able to access the new hosting infrastructure

If you don't already have a Search Console account, [create a new account](https://support.google.com/webmasters/answer/34592) for your site to help you monitor Google access and traffic. If you created a temporary hostname for your new site, verify that property as well. Check that Googlebot can access your new infrastructure using the [URL Inspection Tool](https://support.google.com/webmasters/answer/9012289) in Search Console.

> **Caution**: Check your firewall configuration or denial of service (DoS) protection. Make sure it does not block Googlebot's ability to reach the DNS or the hosting provider's servers. [Learn how to verify Googlebot](https://developers.google.com/search/docs/crawling-indexing/verifying-googlebot#use-automatic-solutions).
...
[^google-site-move-no-url-changes]: Google Search Central (2025). "Changing your hosting". *Google for Developers*. https://developers.google.com/search/docs/crawling-indexing/site-move-no-url-changes. Retrieved 2026-09-01.
