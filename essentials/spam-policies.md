...
description: The spam policies detail the behaviors and tactics that can lead to a page or an entire site being ranked lower or completely omitted from Google Search.
resource: https://developers.google.com/search/docs/essentials/spam-policies
tags:
- google-search
- documentation
- essentials
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/essentials/spam-policies](https://developers.google.com/search/docs/essentials/spam-policies). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2026-08-28.[^google-spam-policies]
...
If your site uses technologies that search engines have difficulty accessing, like [JavaScript](/crawling-indexing/javascript/javascript-seo-basics.md) or [images](/appearance/google-images.md), see our recommendations for making that content accessible to search engines and users without cloaking.
...
- **Content injection**: Hackers might also try to subtly manipulate existing pages on your site. Their goal is to add content to your site that search engines can see but which may be harder for you and your users to spot. This can involve adding [hidden links or hidden text](https://developers.google.com/search/docs/essentials/spam-policies/#hidden-text-and-links) to a page by using CSS or HTML, or it can involve more complex changes like [cloaking](https://developers.google.com/search/docs/essentials/spam-policies/#cloaking).
...
- Requiring a link as part of a Terms of Service, contract, or similar arrangement without allowing a third-party content owner the choice of [qualifying the outbound link](/crawling-indexing/qualify-outbound-links.md)
...
Google does understand that buying and selling links is a normal part of the economy of the web for advertising and sponsorship purposes. It's not a violation of our policies to have such links as long as they are [qualified](/crawling-indexing/qualify-outbound-links.md) with a [`rel="nofollow"`](/crawling-indexing/qualify-outbound-links.md) or [`rel="sponsored"`](/crawling-indexing/qualify-outbound-links.md) attribute value to the `<a>` tag.
...
If you're hosting such content on your site, [exclude it from Search](/crawling-indexing/control-what-you-share.md).
...
- Copying content from other sites, modify it only slightly (for example, by substituting synonyms or using [automated techniques](https://developers.google.com/search/docs/essentials/spam-policies/#scaled-content)), and republish it
...
- Using affiliate links throughout a page, with [links treated appropriately](https://developers.google.com/search/docs/essentials/spam-policies/#link-spam), or embedding third-party ad units throughout a page
...
When examining if a redirect is sneaky, consider whether or not the redirect is intended to deceive either the users or search engines. Learn more about how to appropriately [employ redirects on your site](/crawling-indexing/301-redirects.md).
...
Here are several tips on how to [prevent abuse of your site's public areas](/monitor-debug/prevent-abuse.md). Here are our tips on [fixing hacked sites](https://web.dev/articles/hacked) and avoiding being hacked.
...
[^google-spam-policies]: Google Search Central (2026). "Spam policies for Google web search". *Google for Developers*. https://developers.google.com/search/docs/essentials/spam-policies. Retrieved 2026-09-01.
