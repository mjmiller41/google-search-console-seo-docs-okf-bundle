...
description: Your page experience can impact how your site ranks in Search results. Learn how to evaluate your site and deliver a good page experience.
resource: https://developers.google.com/search/docs/appearance/page-experience
tags:
- google-search
- documentation
- appearance
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/appearance/page-experience](https://developers.google.com/search/docs/appearance/page-experience). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2025-12-10.[^google-page-experience]
...
- [Understanding Core Web Vitals and Google Search results](/appearance/core-web-vitals.md): Learn more about Core Web Vitals and how they work in Google Search results.
...
- [Avoid intrusive interstitials and dialog](/appearance/avoid-intrusive-interstitials.md): Learn how to avoid interstitials that can make content less accessible.
...
Core Web Vitals are used by our ranking systems. We recommend site owners achieve good Core Web Vitals for success with Search and to ensure a great user experience generally. Keep in mind that getting good results in reports like Search Console's [Core Web Vitals report](https://support.google.com/webmasters/answer/9205520) or third-party tools doesn't guarantee that your pages will rank at the top of Google Search results; there's more to great page experience than Core Web Vitals scores alone. These scores are meant to help you to improve your site for your users overall, and trying to get a perfect score just for SEO reasons may not be the best use of your time.
...
Here's everything we've announced about page experience on the [Google Search Central blog](https://developers.google.com/search/blog):

# References & Citations

[^google-page-experience]: Google Search Central (2025). "Understanding page experience in Google Search results". *Google for Developers*. https://developers.google.com/search/docs/appearance/page-experience. Retrieved 2026-09-01.
