---
type: Reference
title: Google Search's reviews system and your website
description: Learn more about how the reviews system works, and what you can do to assess and improve your content.
resource: https://developers.google.com/search/docs/appearance/reviews-system
tags:
- google-search
- documentation
- appearance
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/appearance/reviews-system](https://developers.google.com/search/docs/appearance/reviews-system). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2025-12-10.[^google-reviews-system]
...
In the case of products, [product structured data](/appearance/structured-data/product.md) might help us better identify if something is a product review, but we don't solely depend on it.

## What does this system mean for my site?

To learn more about how to create content that's successful with the reviews system, see our [help page on how to write high quality reviews](/specialty/ecommerce/write-high-quality-reviews.md).
...
[^google-reviews-system]: Google Search Central (2025). "Google Search's reviews system and your website". *Google for Developers*. https://developers.google.com/search/docs/appearance/reviews-system. Retrieved 2026-09-01.
