...
description: Explore some of Google Search's more notable ranking systems, including systems that are part of our core ranking systems, which are the underlying technologies that produce search results in response to queries.
resource: https://developers.google.com/search/docs/appearance/ranking-systems-guide
tags:
- google-search
- documentation
- appearance
...
sources:
- id: google-ranking-systems-guide
  resource: https://developers.google.com/search/docs/appearance/ranking-systems-guide
  title: A guide to Google Search ranking systems
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/appearance/ranking-systems-guide](https://developers.google.com/search/docs/appearance/ranking-systems-guide). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2025-12-10.[^google-ranking-systems-guide]
...
We have systems to help ensure we are showing original content prominently in search results, [including original reporting](https://blog.google/products/search/original-reporting/), ahead of those who merely cite it. This includes support of a special [canonical markup](/crawling-indexing/consolidate-duplicate-urls.md) creators can use to help us better understand what is the primary page if a page has been duplicated in several places.
...
The [reviews system](https://developers.google.com/search/updates/reviews-update) aims to better reward high quality reviews, content that provides insightful analysis and original research, and is written by experts or enthusiasts who know the topic well.
...
[Announced in 2022](https://developers.google.com/search/blog/2022/08/helpful-content-update) as the "Helpful Content Update", this was a system designed to better ensure people see original, helpful content written by people, for people, in search results, rather than content made primarily to gain search engine traffic. In March 2024, it evolved and [became part of](https://developers.google.com/search/blog/2024/03/core-update-spam-policies) our core ranking systems, as our systems use a variety of signals and systems to present helpful results to users.
...
This was a system designed to combat link spam. [Announced in 2012](https://developers.google.com/search/blog/2012/04/another-step-to-reward-high-quality) and given the nickname of the "Penguin Update", it was [integrated](https://developers.google.com/search/blog/2016/09/penguin-is-now-part-of-our-core) into our core ranking systems in 2016.

# References & Citations

[^google-ranking-systems-guide]: Google Search Central (2025). "A guide to Google Search ranking systems". *Google for Developers*. https://developers.google.com/search/docs/appearance/ranking-systems-guide. Retrieved 2026-09-01.
