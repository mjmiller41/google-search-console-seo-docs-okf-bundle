...
type: Reference
title: Sitelinks
description: Find out what sitelinks are, how sitelinks appear in organic search results, and how they can help users better navigate your site.
resource: https://developers.google.com/search/docs/appearance/sitelinks
tags:
- google-search
- documentation
- appearance
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/appearance/sitelinks](https://developers.google.com/search/docs/appearance/sitelinks). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2025-12-10.[^google-sitelinks]
...
If you need to remove a sitelink, consider removing the page from your site or using [`noindex`.](/crawling-indexing/block-indexing.md)

# References & Citations

[^google-sitelinks]: Google Search Central (2025). "Sitelinks". *Google for Developers*. https://developers.google.com/search/docs/appearance/sitelinks. Retrieved 2026-09-01.
