...
description: Use banners instead of interstitials and large dialogs on your website.
resource: https://developers.google.com/search/docs/appearance/avoid-intrusive-interstitials
tags:
- google-search
- documentation
- appearance
...
sources:
- id: google-avoid-intrusive-interstitials
  resource: https://developers.google.com/search/docs/appearance/avoid-intrusive-interstitials
  title: Avoid intrusive interstitials and dialogs
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/appearance/avoid-intrusive-interstitials](https://developers.google.com/search/docs/appearance/avoid-intrusive-interstitials). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2025-12-10.[^google-avoid-intrusive-interstitials]
...
For content behind a mandatory age gate for adult users, we recommend allowing Googlebot to crawl your content without triggering the age gate. You can do this by [verifying Googlebot requests](https://developers.google.com/search/docs/crawling-indexing/verifying-googlebot) and serving the content without age gate.

# References & Citations

[^google-avoid-intrusive-interstitials]: Google Search Central (2025). "Avoid intrusive interstitials and dialogs". *Google for Developers*. https://developers.google.com/search/docs/appearance/avoid-intrusive-interstitials. Retrieved 2026-09-01.
