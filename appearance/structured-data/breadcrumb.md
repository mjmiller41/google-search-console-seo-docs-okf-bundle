...
[^google-breadcrumb]: Google Search Central (2025). "Breadcrumb (BreadcrumbList) structured data". *Google for Developers*. https://developers.google.com/search/docs/appearance/structured-data/breadcrumb. Retrieved 2026-09-01.
