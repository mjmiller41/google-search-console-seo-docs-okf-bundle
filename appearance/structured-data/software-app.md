...
[^google-software-app]: Google Search Central (2026). "Software app (SoftwareApplication) structured data". *Google for Developers*. https://developers.google.com/search/docs/appearance/structured-data/software-app. Retrieved 2026-09-14.
