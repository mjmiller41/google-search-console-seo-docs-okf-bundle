...
[^google-course]: Google Search Central (2025). "Course list (Course) structured data". *Google for Developers*. https://developers.google.com/search/docs/appearance/structured-data/course. Retrieved 2026-09-01.
