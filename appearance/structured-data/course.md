---
type: Reference
title: Course list (Course) structured data
description: Mark up your course lists with structured data so students can find you on Google Search. Explore this article for list guidelines and course schema.
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/appearance/structured-data/course](https://developers.google.com/search/docs/appearance/structured-data/course). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2026-09-08.[^google-course]

![An illustration of how a course list can appear in Google Search. It shows 3 different courses from the same website in a list format that users can explore and select a specific course](https://developers.google.com/static/search/docs/images/course-carousel-rich-result.png)
...
1.  Add the [required properties](https://developers.google.com/search/docs/appearance/structured-data/course/#structured-data-type-definitions). Based on the format you're using, learn where to [insert structured data on the page](/appearance/structured-data/intro-structured-data.md).
...
2.  Follow the [guidelines](https://developers.google.com/search/docs/appearance/structured-data/course/#guidelines).
...
Here's an example of a single course details page. This page must be paired with a [summary page](/appearance/structured-data/carousel.md) that contains the [`ItemList` markup](https://developers.google.com/search/docs/appearance/structured-data/course/#item-list).
...
Here's an example of a [single, all-in-one page](/appearance/structured-data/carousel.md). This page setup includes both the list markup and the details for each course on the same page.
...
- [Content guidelines](https://developers.google.com/search/docs/appearance/structured-data/course/#content-guidelines)
- [Technical guidelines](https://developers.google.com/search/docs/appearance/structured-data/course/#technical-guidelines)
...
You must mark up at least three courses. The courses can be on separate [detail pages](/appearance/structured-data/carousel.md), or in an [all-in-one page](/appearance/structured-data/carousel.md).

You must add [Carousel markup](/appearance/structured-data/carousel.md) to either a [summary page](/appearance/structured-data/carousel.md) or an [all-in-one page](/appearance/structured-data/carousel.md).
...
Use the following properties to mark up at least three courses. The courses can be on separate [detail pages](/appearance/structured-data/carousel.md), or in an [all-in-one page](/appearance/structured-data/carousel.md).
...
<p>A description of the course. Display limit of 60 characters.</p></td>
</tr>
<tr>
<td><code>name</code></td>
<td><p><code><a href="https://schema.org/Text">Text</a></code></p>
<p>The title of the course.</p></td>
</tr>
</tbody>
</table> <table>
<colgroup><col/></colgroup>
...
<p>The organization that publishes the source content of the course. For example,
        UC Berkeley.</p></td>
</tr>
</tbody>
</table>
...
In addition to [`Course` properties](https://developers.google.com/search/docs/appearance/structured-data/course/#course), add the following properties to specify the list. You can add these properties to either a [summary page](/appearance/structured-data/carousel.md) or an [all-in-one page](/appearance/structured-data/carousel.md).
...
<p>Ordinal position of the item page in the list.</p></td>
</tr>
<tr>
...
- Review the [guidelines](https://developers.google.com/search/docs/appearance/structured-data/course/#guidelines) again to identify if your content isn't compliant with the guidelines. The problem can be caused by either spammy content or spammy markup usage. However, the issue may not be a syntax issue, and so the Rich Results Test won't be able to identify these issues.
...
[^google-course]: Google Search Central (2026). "Course list (Course) structured data". *Google for Developers*. https://developers.google.com/search/docs/appearance/structured-data/course. Retrieved 2026-09-14.
