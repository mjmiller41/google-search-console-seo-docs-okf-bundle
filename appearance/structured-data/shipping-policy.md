...
[^google-shipping-policy]: Google Search Central (2026). "Merchant shipping policy (ShippingService) structured data". *Google for Developers*. https://developers.google.com/search/docs/appearance/structured-data/shipping-policy. Retrieved 2026-09-14.
