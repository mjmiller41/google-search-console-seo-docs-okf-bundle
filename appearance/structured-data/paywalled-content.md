...
[^google-paywalled-content]: Google Search Central (2026). "Structured data for subscription and paywalled content (CreativeWork)". *Google for Developers*. https://developers.google.com/search/docs/appearance/structured-data/paywalled-content. Retrieved 2026-09-14.
