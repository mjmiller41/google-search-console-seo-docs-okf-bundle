...
[^google-discussion-forum]: Google Search Central (2026). "Discussion forum (DiscussionForumPosting) structured data". *Google for Developers*. https://developers.google.com/search/docs/appearance/structured-data/discussion-forum. Retrieved 2026-09-01.
