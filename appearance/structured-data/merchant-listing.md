...
[^google-merchant-listing]: Google Search Central (2026). "Merchant listing (Product, Offer) structured data". *Google for Developers*. https://developers.google.com/search/docs/appearance/structured-data/merchant-listing. Retrieved 2026-09-14.
