...
[^google-employer-rating]: Google Search Central (2026). "Employer aggregate rating (EmployerAggregateRating) structured data". *Google for Developers*. https://developers.google.com/search/docs/appearance/structured-data/employer-rating. Retrieved 2026-09-14.
