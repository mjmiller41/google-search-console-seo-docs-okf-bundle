...
[^google-factcheck]: Google Search Central (2026). "Fact check (ClaimReview) structured data". *Google for Developers*. https://developers.google.com/search/docs/appearance/structured-data/factcheck. Retrieved 2026-09-14.
