...
[^google-loyalty-program]: Google Search Central (2026). "Loyalty program (MemberProgram) structured data". *Google for Developers*. https://developers.google.com/search/docs/appearance/structured-data/loyalty-program. Retrieved 2026-09-14.
