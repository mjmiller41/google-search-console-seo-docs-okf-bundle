...
[^google-product-snippet]: Google Search Central (2026). "Product snippet (Product, Review, Offer) structured data". *Google for Developers*. https://developers.google.com/search/docs/appearance/structured-data/product-snippet. Retrieved 2026-09-14.
