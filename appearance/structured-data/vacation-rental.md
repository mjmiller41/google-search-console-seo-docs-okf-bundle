...
[^google-vacation-rental]: Google Search Central (2026). "Vacation rental (VacationRental) structured data". *Google for Developers*. https://developers.google.com/search/docs/appearance/structured-data/vacation-rental. Retrieved 2026-09-14.
