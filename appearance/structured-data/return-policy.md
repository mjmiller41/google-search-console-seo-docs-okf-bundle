...
[^google-return-policy]: Google Search Central (2025). "Merchant return policy (MerchantReturnPolicy) structured data". *Google for Developers*. https://developers.google.com/search/docs/appearance/structured-data/return-policy. Retrieved 2026-09-01.
