---
type: Reference
title: Flexible Sampling general guidance
description: 'We recommend two types of flexible sampling: metering and lead-in. Explore general guidance for flexible sampling including metering and paywalls.'
resource: https://developers.google.com/search/docs/appearance/flexible-sampling
tags:
- google-search
- documentation
- appearance
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/appearance/flexible-sampling](https://developers.google.com/search/docs/appearance/flexible-sampling). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2025-12-10.[^google-flexible-sampling]
...
Enclose paywalled content with structured data in order to help Google differentiate paywalled content from the practice of [cloaking](https://developers.google.com/search/docs/advanced/guidelines/cloaking), where the content served to Googlebot is different from the content served to users. If you don't want the content to be accessible to the browser at the time of serving, choose a paywall implementation that doesn't supply the paywalled content to the browser.

Learn more about how to [indicate paywalled content with structured data](/appearance/structured-data/paywalled-content.md) and refer to our [guidance on using JavaScript to implement paywalled content](/crawling-indexing/javascript/fix-search-javascript.md).

# References & Citations

[^google-flexible-sampling]: Google Search Central (2025). "Flexible Sampling general guidance". *Google for Developers*. https://developers.google.com/search/docs/appearance/flexible-sampling. Retrieved 2026-09-01.
