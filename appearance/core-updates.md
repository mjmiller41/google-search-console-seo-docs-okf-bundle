---
type: Reference
title: Google Search's core updates and your website
description: Learn about how core updates work, and what you can do to assess and perhaps improve your content.
resource: https://developers.google.com/search/docs/appearance/core-updates
tags:
- google-search
- documentation
- appearance
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/appearance/core-updates](https://developers.google.com/search/docs/appearance/core-updates). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2025-12-10.[^google-core-updates]

Several times a year, Google makes significant, broad changes to our [search algorithms and systems](https://www.google.com/search/howsearchworks/how-search-works/ranking-results/). We refer to these as core updates, and we give notice when they happen on our [list of Google Search ranking updates](https://status.search.google.com/products/rGHU1u87FJnkP6W2GwMi/history).
...
If you're seeing a drop in position and suspect it might correlate with the [timing of a core update](https://status.search.google.com/products/rGHU1u87FJnkP6W2GwMi/history), use Search Console to determine whether you need to make a change.
...
3.  **Review your top pages and queries.** Assess how they were ranking before and after the core update: is the drop small or large?
    - **[Small drop in position](/monitor-debug/debugging-search-traffic-drops.md) (dropping from position 2 to 4)**: There's no need to take drastic action (in fact, we recommend avoiding making changes to content that's already performing well).
    - **Large drop in position (dropping from position 4 to 29)**: Do a [deeper assessment](https://developers.google.com/search/docs/appearance/core-updates/#assess-large-drop).
4.  **[Analyze different search types separately](/monitor-debug/debugging-search-traffic-drops.md)**: This can help you understand whether the drop you've seen happened in Web Search, Google Images, Video mode, or the News tab.

## Assessing a large drop in position

If you're seeing a sustained, large drop in position for your site as a whole, read through the [self-assessment](/fundamentals/creating-helpful-content.md) to check if your site overall (not just individual pages) is delivering content that's helpful, reliable, and people first. Specifically, we recommend keeping the following in mind:

- **Take a close look at your site as a whole, and try to be objective.** You might also ask others you trust (that are unaffiliated with your site) to do an [assessment using the questions](/fundamentals/creating-helpful-content.md).
- **Evaluate the pages that were most impacted.** Look closely at these to understand how these pages may perform against the [self-assessment questions](/fundamentals/creating-helpful-content.md). For example, there may be other pages on the web that are doing a better job of helping the searcher.
...
[^google-core-updates]: Google Search Central (2025). "Google Search's core updates and your website". *Google for Developers*. https://developers.google.com/search/docs/appearance/core-updates. Retrieved 2026-09-01.
