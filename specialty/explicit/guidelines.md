...
description: If your site hosts explicit or adult content, you can help Google understand the nature of your site and content, which can help Google to more accurately categorize your site and ensure user preference regarding explicit content.
...
> **Is your site being incorrectly flagged as explicit?** Check our [troubleshooting guide](/specialty/explicit/troubleshooting.md) for more on how to confirm if your site has been incorrectly categorized and how to fix the issue.
...
For more information on our ranking systems, check out our [removal-based demotion systems](/appearance/ranking-systems-guide.md) and [spam policies](/essentials/spam-policies.md).
...
1.  [Prevent user-generated harmful content on your platform](https://developers.google.com/search/docs/specialty/explicit/guidelines/#prevent-user-generated-harmful-content).
2.  [Allow Google to fetch your video content files](https://developers.google.com/search/docs/specialty/explicit/guidelines/#allow-google-to-fetch).
...
Allowing Googlebot to [fetch your video files](/appearance/video.md) enables Google to understand the video content and reduces the chance of exposing users to violative explicit content, such as CSAM and non-consensual explicit content.
...
Google has algorithms to automatically detect explicit pages, including text, images, and videos. While not necessary, adding metadata can be be a practical way for you to tag a few explicit pages on your site or if you want to be sure that a particular page is filtered for SafeSearch users:

- [Add metadata to pages with explicit content](https://developers.google.com/search/docs/specialty/explicit/guidelines/#add-metadata).
- [Use the `<video:family_friendly>` tag in your video sitemap](https://developers.google.com/search/docs/specialty/explicit/guidelines/#use-video-family-friendly-tag).

#### Add metadata to pages with sexually explicit content

To mark a particular page as explicit, add [rating markup](/crawling-indexing/special-tags.md) with the `adult` value either as a [`meta` tag](/crawling-indexing/special-tags.md) or an HTTP response header. We recommend adding this tag to any page with sexually explicit content.
