...
description: Learn how to write high quality reviews and see how they can help shoppers discover your reviews in Search.
resource: https://developers.google.com/search/docs/specialty/ecommerce/write-high-quality-reviews
tags:
- google-search
- documentation
- specialty
...
sources:
- id: google-write-high-quality-reviews
  resource: https://developers.google.com/search/docs/specialty/ecommerce/write-high-quality-reviews
  title: Write high quality reviews
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/specialty/ecommerce/write-high-quality-reviews](https://developers.google.com/search/docs/specialty/ecommerce/write-high-quality-reviews). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2025-12-10.[^google-write-high-quality-reviews]
...
Reviews often use affiliate links, so that if someone finds a review useful and follows the provided link to purchase, the creator of the review is rewarded by the seller. If you do this, see also [Google's position on affiliate programs](/essentials/spam-policies.md).
...
[^google-write-high-quality-reviews]: Google Search Central (2025). "Write high quality reviews". *Google for Developers*. https://developers.google.com/search/docs/specialty/ecommerce/write-high-quality-reviews. Retrieved 2026-09-01.
