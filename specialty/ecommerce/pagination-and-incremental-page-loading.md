...
description: Learn best practices for indexing your ecommerce site when using pagination and incremental page loading and how this can impact Google Search.
resource: https://developers.google.com/search/docs/specialty/ecommerce/pagination-and-incremental-page-loading
tags:
- google-search
- documentation
- specialty
...
sources:
- id: google-pagination-and-incremental-page-loading
  resource: https://developers.google.com/search/docs/specialty/ecommerce/pagination-and-incremental-page-loading
  title: Pagination, incremental page loading, and their impact on Google Search
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/specialty/ecommerce/pagination-and-incremental-page-loading](https://developers.google.com/search/docs/specialty/ecommerce/pagination-and-incremental-page-loading). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2025-12-10.[^google-pagination-and-incremental-page-loading]
...
- **Infinite scroll**: Where a user can scroll to the end of the page to cause more content to be loaded. (Learn more about [infinite scroll search-friendly recommendations](/crawling-indexing/javascript/lazy-loading.md).)
...
If your site uses JavaScript, follow these [JavaScript SEO best practices](/crawling-indexing/javascript/javascript-seo-basics.md). In addition to best practices, such as making sure links on your site are crawlable, consider using a [sitemap](/crawling-indexing/sitemaps/build-sitemap.md) file or a [Google Merchant Center feed](https://support.google.com/merchants/answer/7439058) to help Google find all of the products on your site.
...
- [Link pages sequentially](https://developers.google.com/search/docs/specialty/ecommerce/pagination-and-incremental-page-loading/#sequentially)
- [Use URLs correctly](https://developers.google.com/search/docs/specialty/ecommerce/pagination-and-incremental-page-loading/#use-urls-correctly)
- [Avoid indexing URLs with filters or alternative sort orders](https://developers.google.com/search/docs/specialty/ecommerce/pagination-and-incremental-page-loading/#avoid-indexing-variations)
...
- **Don't use the first page of a paginated sequence as the canonical page**. Instead, give each page its own [canonical URL](/crawling-indexing/consolidate-duplicate-urls.md).
...
To avoid indexing variations of the same list of results, block unwanted URLs from being indexed with the [`noindex` robots `meta` tag](/crawling-indexing/block-indexing.md) or discourage crawling of particular [URL patterns with a robots.txt file](https://developers.google.com/search/docs/crawling-indexing/robots/robots_txt#url-matching-based-on-path-values).

# References & Citations

[^google-pagination-and-incremental-page-loading]: Google Search Central (2025). "Pagination, incremental page loading, and their impact on Google Search". *Google for Developers*. https://developers.google.com/search/docs/specialty/ecommerce/pagination-and-incremental-page-loading. Retrieved 2026-09-01.
