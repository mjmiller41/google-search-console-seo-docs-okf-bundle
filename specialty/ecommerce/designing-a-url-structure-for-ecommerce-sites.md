...
description: Learn how you can design a URL structure for your ecommerce website and best practices to help Google efficiently locate and retrieve your web pages.
resource: https://developers.google.com/search/docs/specialty/ecommerce/designing-a-url-structure-for-ecommerce-sites
tags:
- google-search
- documentation
- specialty
...
sources:
- id: google-designing-a-url-structure-for-ecommerce-sites
  resource: https://developers.google.com/search/docs/specialty/ecommerce/designing-a-url-structure-for-ecommerce-sites
  title: Designing a URL structure for ecommerce websites
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/specialty/ecommerce/designing-a-url-structure-for-ecommerce-sites](https://developers.google.com/search/docs/specialty/ecommerce/designing-a-url-structure-for-ecommerce-sites). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2025-12-10.[^google-designing-a-url-structure-for-ecommerce-sites]
...
See [How Google Search Works](/fundamentals/how-search-works.md) and [How Google's Site Crawlers Index Your Site](https://www.google.com/search/howsearchworks/crawling-indexing/) for more information on how Google crawls and indexes your site.
...
For more information, see the [product variant structured data documentation](/appearance/structured-data/product-variants.md).

If you use optional query parameters to identify variants, use the URL with the query parameter omitted as the [canonical URL](/crawling-indexing/consolidate-duplicate-urls.md). This can help Google better understand the relationship between product variants.
...
- Use the same URL in internal links, sitemap files, and [`<link rel="canonical">` tags](/crawling-indexing/consolidate-duplicate-urls.md). For example, if linking to the first page in a paginated sequence using a query parameter where the default page is page one, either include or exclude `?page=1` on the URL throughout your site consistently.
- Use a self-referencing [`<link rel="canonical">` tag](/crawling-indexing/consolidate-duplicate-urls.md) (one where the URL in the tag points to the current page) on all indexable pages and include those URLs in a [sitemap](/crawling-indexing/sitemaps/build-sitemap.md) file.
...
- Avoid linking to, or at least indexing, pages without useful content. If a category has no items, use a [`noindex` robots `meta` tag](/crawling-indexing/robots-meta-tag.md). If your site detects that a category has become empty and automatically removes the category from on-site search and browse, consider returning a `404 (not found)` HTTP status code for the page.

## Additional resources

Want to learn more? Check out the following resources:

- [Help Google understand your site structure](/specialty/ecommerce/help-google-understand-your-ecommerce-site-structure.md)
- [Avoid creating duplicate content](/crawling-indexing/consolidate-duplicate-urls.md)
- [Pagination, incremental page loading, and their impact on Search](/specialty/ecommerce/pagination-and-incremental-page-loading.md)
...
[^google-designing-a-url-structure-for-ecommerce-sites]: Google Search Central (2025). "Designing a URL structure for ecommerce websites". *Google for Developers*. https://developers.google.com/search/docs/specialty/ecommerce/designing-a-url-structure-for-ecommerce-sites. Retrieved 2026-09-01.
