---
type: Reference
title: Share your product data with Google
description: Learn how you can share product data with Google using structured data and Google Merchant Center, and how it can be useful for rich results.
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/specialty/ecommerce/share-your-product-data-with-google](https://developers.google.com/search/docs/specialty/ecommerce/share-your-product-data-with-google). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2025-12-10.[^google-share-your-product-data-with-google]

To increase eligibility for [richer appearances and on more surfaces across Google](/specialty/ecommerce/where-ecommerce-data-can-appear-on-google.md) that can bring more relevant traffic to your site, share your ecommerce product data with Google. To take advantage of these benefits, Google recommends that you do the following:

- **Include structured data in your site's product pages**. Learn more about the benefits of [adding structured data to your web pages](https://developers.google.com/search/docs/specialty/ecommerce/share-your-product-data-with-google/#add-structured-data).
- **Tell Google directly which products you want to show on Google** by uploading a feed to [Google Merchant Center](https://support.google.com/merchants/answer/188924). Google Merchant Center is a Google service that has a deeper understanding of commerce data. Learn more about the [benefits of Google Merchant Center](https://developers.google.com/search/docs/specialty/ecommerce/share-your-product-data-with-google/#upload-product-data).
...
- Structured data increases eligibility for [Product rich results](/appearance/structured-data/product.md).
...
Ready to start implementing? Check out [Include structured data relevant to ecommerce](/specialty/ecommerce/include-structured-data-relevant-to-ecommerce.md) for more information.

Google may at times use other approaches to extract data from pages. If you want to explicitly tell Google not to use content on a page to form a snippet, add a [`data-nosnippet` attribute](/crawling-indexing/robots-meta-tag.md) to that HTML element.
...
[^google-share-your-product-data-with-google]: Google Search Central (2025). "Share your product data with Google". *Google for Developers*. https://developers.google.com/search/docs/specialty/ecommerce/share-your-product-data-with-google. Retrieved 2026-09-01.
