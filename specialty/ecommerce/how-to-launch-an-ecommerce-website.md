---
type: Reference
title: How to launch a new ecommerce website
description: Learn how to launch a new ecommerce website and what we recommend doing to register your new website so that it will be discoverable on Google.
resource: https://developers.google.com/search/docs/specialty/ecommerce/how-to-launch-an-ecommerce-website
tags:
- google-search
- documentation
- specialty
...
sources:
- id: google-how-to-launch-an-ecommerce-website
  resource: https://developers.google.com/search/docs/specialty/ecommerce/how-to-launch-an-ecommerce-website
  title: How to launch a new ecommerce website
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/specialty/ecommerce/how-to-launch-an-ecommerce-website](https://developers.google.com/search/docs/specialty/ecommerce/how-to-launch-an-ecommerce-website). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2025-12-10.[^google-how-to-launch-an-ecommerce-website]
...
2.  [Ask Google to index your site](/crawling-indexing/ask-google-to-recrawl.md):

    - **Small number of URLs:** Use the [URL inspection tool](https://support.google.com/webmasters/answer/9012289).
    - **Large number of URLs:** Provide a [sitemap](/crawling-indexing/sitemaps/build-sitemap.md).
...
4.  If you also have a physical store, [establish your business details with Google](/appearance/establish-business-details.md).
...
- [Grand reveal](https://developers.google.com/search/docs/specialty/ecommerce/how-to-launch-an-ecommerce-website/#grand-reveal): Make your entire site live to the public and Google at the same time.
- [Home page launch](https://developers.google.com/search/docs/specialty/ecommerce/how-to-launch-an-ecommerce-website/#home%20page-launch): Initially make only the home page of the site available to the public and Google.
- [Launch without product availability](https://developers.google.com/search/docs/specialty/ecommerce/how-to-launch-an-ecommerce-website/#products-unavailable): Launch the full site to the public and Google, with products marked as "out of stock".
- [Soft launch](https://developers.google.com/search/docs/specialty/ecommerce/how-to-launch-an-ecommerce-website/#soft-launch): Launch the full site live early, with a separate marketing event for the "official" launch.
...
**Action**: Immediately after launch, follow the steps to [launching an ecommerce site](https://developers.google.com/search/docs/specialty/ecommerce/how-to-launch-an-ecommerce-website/#steps). This will minimize the delay before your site is available on Google Search.
...
**Action**: [Verify your site ownership](https://support.google.com/webmasters/answer/9008080) in advance, then proceed with the [rest of the steps](https://developers.google.com/search/docs/specialty/ecommerce/how-to-launch-an-ecommerce-website/#steps) once your products are available on your site.
...
**Actions**: [Do all of the steps to launching your ecommerce site](https://developers.google.com/search/docs/specialty/ecommerce/how-to-launch-an-ecommerce-website/#steps), but provide product data to Google Merchant Center with stock marked as unavailable for purchase using the [`excluded_destination` attribute](https://support.google.com/merchants/answer/6324486). This allows any product data loading verification issues to be identified earlier, without your products appearing as available in destinations such as Google Shopping.
...
**Actions**: [Do all of the steps to launching an ecommerce site](https://developers.google.com/search/docs/specialty/ecommerce/how-to-launch-an-ecommerce-website/#steps) as soon as the site goes live.
...
[^google-how-to-launch-an-ecommerce-website]: Google Search Central (2025). "How to launch a new ecommerce website". *Google for Developers*. https://developers.google.com/search/docs/specialty/ecommerce/how-to-launch-an-ecommerce-website. Retrieved 2026-09-01.
