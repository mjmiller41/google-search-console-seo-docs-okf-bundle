---
type: Reference
title: Analyze your social and video platform content performance in Search Console
description: Whether you're a content creator, social media manager, or SEO professional, learn how to analyze your social and video platform content performance on Google Search using Search Console.
resource: https://developers.google.com/search/docs/monitor-debug/analyze-social-video-content
tags:
- google-search
- documentation
- monitor-debug
...
sources:
- id: google-analyze-social-video-content
  resource: https://developers.google.com/search/docs/monitor-debug/analyze-social-video-content
  title: Analyze your social and video platform content performance in Search Console
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/monitor-debug/analyze-social-video-content](https://developers.google.com/search/docs/monitor-debug/analyze-social-video-content). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2026-07-29.[^google-analyze-social-video-content]
...
<tr>
<td>
<img alt="Short video carousel in Google Search" src="https://developers.google.com/static/search/docs/images/short-videos.png"/>
</td>
<td>
<img alt="Latest posts carousel in Google Search" src="https://developers.google.com/static/search/docs/images/latest-posts.png"/>
</td>
<td>
<img alt="What people are saying carousel in Google Search" src="https://developers.google.com/static/search/docs/images/what-people-are-saying.png"/>
</td>
</tr>
</table>
...
> **Key Point:** It's a good idea to also [monitor rising topics](/monitor-debug/trends-start.md) using Google Trends.
...
> **Key Point:** If you want to go the extra mile, consider [using Google Trends](/monitor-debug/trends-start.md); it helps you monitor rising trends, perform keyword research, create a content calendar, and more.

# References & Citations

[^google-analyze-social-video-content]: Google Search Central (2026). "Analyze your social and video platform content performance in Search Console". *Google for Developers*. https://developers.google.com/search/docs/monitor-debug/analyze-social-video-content. Retrieved 2026-09-01.
