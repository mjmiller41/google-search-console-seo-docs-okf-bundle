---
type: Reference
title: Improving SEO with a Search Console bubble chart
description: A bubble chart can help you understand which queries are performing well for your site in Google Search, and which could be improved.
resource: https://developers.google.com/search/docs/monitor-debug/bubble-chart-analysis
tags:
- google-search
- documentation
- monitor-debug
...
sources:
- id: google-bubble-chart-analysis
  resource: https://developers.google.com/search/docs/monitor-debug/bubble-chart-analysis
  title: Improving SEO with a Search Console bubble chart
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/monitor-debug/bubble-chart-analysis](https://developers.google.com/search/docs/monitor-debug/bubble-chart-analysis). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2025-12-10.[^google-bubble-chart-analysis]
...
![Elements in the Search Console bubble chart](https://developers.google.com/static/search/docs/images/search-console-bubble-chart.png)
...
2.  **Log scale**: Using a [logarithmic scale](https://en.wikipedia.org/wiki/Logarithmic_scale) for both axes lets you to have a better understanding of queries that are in the extremities of the chart (very low CTR, average position, or both).
3.  **[Reference lines](https://support.google.com/datastudio/answer/9921462)**: The reference line is very helpful to highlight values that are above or below a certain threshold. Looking at the average, median, or a certain percentile can call attention to deviations from the pattern.
...
![Bubble chart showing four types of query performance](https://developers.google.com/static/search/blog/images/query-performance-types.png)
...
After you find the queries using the visualization shown in this page, you can [create a query filter](https://support.google.com/webmasters/answer/7576553#filteringdata) for specific queries using the Search Console user interface, or create a [pivot table](https://support.google.com/looker-studio/answer/7516660) using Looker Studio; in both ways, you can check all the pages that are receiving traffic for a specific query. After you know the queries you want to optimize and their related URLs, use the [SEO starter guide](/fundamentals/seo-starter-guide.md) to optimize your content. Here are some tips:

- Ensure that your [title](/appearance/title-link.md) elements, [description meta tags](/appearance/snippet.md), and alt attributes are descriptive, specific, and accurate.
...
[^google-bubble-chart-analysis]: Google Search Central (2025). "Improving SEO with a Search Console bubble chart". *Google for Developers*. https://developers.google.com/search/docs/monitor-debug/bubble-chart-analysis. Retrieved 2026-09-01.
