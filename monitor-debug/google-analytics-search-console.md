...
resource: https://developers.google.com/search/docs/monitor-debug/google-analytics-search-console
tags:
- google-search
- documentation
- monitor-debug
...
sources:
- id: google-google-analytics-search-console
  resource: https://developers.google.com/search/docs/monitor-debug/google-analytics-search-console
  title: Using Search Console and Google Analytics data for SEO
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/monitor-debug/google-analytics-search-console](https://developers.google.com/search/docs/monitor-debug/google-analytics-search-console). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2026-01-07.[^google-google-analytics-search-console]

Using [Search Console](/monitor-debug/search-console-start.md) and [Google Analytics](https://developers.google.com/analytics) together can give you a more comprehensive picture of how your audience discovers and experiences your website, which can help you make more informed decisions as you work on your site's SEO. This guide explains how to use [Looker Studio](https://support.google.com/looker-studio/answer/6283323) to monitor metrics from Search Console and Google Analytics, visualize the data together, and troubleshoot data discrepancies between the tools.
...
<td>
<p>
<b>Search Console Clicks</b>
</p>
<p>
          A <em><a href="https://support.google.com/webmasters/answer/7042828#click">click</a></em>
          happens when a person clicks on a link in a Google Search result leading to your website.
        </p>
</td>
<td>
<p>
<b>Google Analytics Sessions</b>
</p>
<p>
          A <em><a href="https://support.google.com/analytics/answer/9191807">session</a></em>
...
> Clicks and sessions are calculated differently, which means that when you compare the data, you'll likely see different numbers. To learn more about why the numbers are different, read the section on [understanding data discrepancies](https://developers.google.com/search/docs/monitor-debug/google-analytics-search-console/#discrepancies).
...
![Filtering the session source and session medium in Looker Studio](https://developers.google.com/static/search/docs/images/scga-session-source-medium.png)
...
![Filters and data controls in Looker Studio](https://developers.google.com/static/search/docs/images/scga-filters-data-controls.png)
...
2.  **Country and device**: Include or exclude countries and device categories.
    ...
    > To compare apples to apples, we recommend that you **pick the same filter for both data sources**. So if you're filtering Search Console to mobile devices in Australia, be sure to change your Google Analytics filters too.
...
![Metrics in the Looker Studio dashboard: sessions, engagement rate, returning users, clicks and CTR](https://developers.google.com/static/search/docs/images/scga-metrics.png) <table>
<thead>
<tr>
<th colspan="2">Metrics in the dashboard</th>
</tr>
</thead>
<tbody>
<tr>
...
<td>A period of time during which a user interacts with your website. In the context of a
        ...
        <a href="https://support.google.com/analytics/answer/9191807">how sessions are counted</a>.
      </td>
</tr>
<tr>
<td><b>2. Engagement rate</b>
<br/>(Google Analytics)
      </td>
<td>
<p>
...
<ul>
<li>A session that had a <i><a href="https://support.google.com/analytics/answer/9355848">key event</a></i></li>
<li>A session that lasted longer than 10 seconds</li>
<li>A session that had 2 or more page views</li>
</ul>
<p>
          Learn more <a href="https://support.google.com/analytics/answer/11109416">about engagement rate</a>.
        </p>
</td>
</tr>
<tr>
<td><b>3. Returning users</b>
<br/>
        (Google Analytics)
      </td>
<td>The percentage of users who have initiated at least one previous session and came back to
        your website. This shows whether people come back to your website through organic Search.
        Learn more <a href="https://support.google.com/analytics/answer/12253918">about returning users</a>.
      </td>
</tr>
<tr>
<td><b>4. Clicks</b>
...
<td>The total number of clicks from Google Search results leading the user to your website.
        Learn more about <a href="https://support.google.com/webmasters/answer/7042828#click">how clicks are counted</a>.
      </td>
</tr>
<tr>
<td><b>5. Click-through rate (CTR)</b>
<br/>
        (Search Console)
      </td>
<td>The click count divided by the impression count. This shows how often users who see your
...
> Even though the sources of data are different, the general trends and patterns should be similar. If you see that the charts are significantly different, read through the [discrepancies section](https://developers.google.com/search/docs/monitor-debug/google-analytics-search-console/#discrepancies).

![Charts in the Looker Studio dashboard: sessions and engagement rate over time, percentage of organic search traffic over time, clicks and CTR over time, top pages and queries by click and CTR, and top countries tables](https://developers.google.com/static/search/docs/images/scga-charts.png)
...
1.  **Organic sessions and engagement rate over time**: Sessions show the volume of traffic you're getting from Search, and engagement rate shows the quality of the traffic; having both together is a good way to assess if your organic search traffic is doing well.
    - **If you see a big change in your organic traffic,** go to Search Console to analyze further, we have documentation explaining [what to do if you see a drop in traffic](/monitor-debug/debugging-search-traffic-drops.md).
...
3.  **Clicks and CTR over time**: Clicks and CTR show volume and quality of your performance on Google Search: they show if people click your site in search results and if your search [snippets](/appearance/snippet.md) are successful in persuading people to click through. If you see a change in your usual pattern, check which specific queries and pages [experienced a drop](/monitor-debug/debugging-search-traffic-drops.md) or a spike.
...
- **Big discrepancy**: If the difference is considerable, look further into the [following reasons](https://developers.google.com/search/docs/monitor-debug/google-analytics-search-console/#big-discrepancy). You may be able to minimize the difference, or at least pinpoint the reason why the numbers vary.
...
<thead>
<tr>
<th colspan="2">Reasons for a big discrepancy in clicks and sessions</th>
</tr>
</thead>
<tbody>
<tr>
<td><b>Implementation in Google Analytics</b></td>
<td>
<p>
          ...
          <a href="https://support.google.com/analytics/answer/9304153">set up guide</a>.
        </p>
<p>
...
<tr>
<td><b>Cookies or tracking</b></td>
<td>
<p>
          If your site is asking users to accept tracking, and users opt out, that can skew Google
          Analytics data. Read this
          <a href="https://support.google.com/analytics/answer/12329599">introduction to user consent management</a>
...
<p>
          ...
          Console, where the <a href="https://support.google.com/webmasters/answer/7576553#timezone">default time zone is Pacific Time (PT)</a>.
...
<td>
<p>
          There are <a href="https://support.google.com/analytics/answer/10596866">three attribution models</a>
...
<tr>
<td><b>Canonical URLs</b></td>
<td>
<p>
          Search Console <a href="https://support.google.com/webmasters/answer/7042828#url">reports only on the Google Search canonical URL</a>,
...
<p>
          ...
          <a href="https://support.google.com/analytics/answer/9216061">enhanced measurement events.</a>
</p>
</td>
</tr>
<tr>
<td><b>Bot traffic</b></td>
<td>
<p>
          Google Analytics <a href="https://support.google.com/analytics/answer/9888366">automatically excludes traffic from known bots</a>
...
[^google-google-analytics-search-console]: Google Search Central (2026). "Using Search Console and Google Analytics data for SEO". *Google for Developers*. https://developers.google.com/search/docs/monitor-debug/google-analytics-search-console. Retrieved 2026-09-01.
