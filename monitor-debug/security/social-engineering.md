---
type: Reference
title: Social engineering (phishing and deceptive sites)
description: Social engineering includes phishing and fake sites, and is a technique to trick users into doing something dangerous. This document provides an overview of social engineering and preventative measures.
resource: https://developers.google.com/search/docs/monitor-debug/security/social-engineering
tags:
- google-search
- documentation
- monitor-debug
...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/monitor-debug/security/social-engineering](https://developers.google.com/search/docs/monitor-debug/security/social-engineering). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2025-12-10.[^google-social-engineering]
...
Sometimes embedded social engineering content will be visible to users on the host page, as shown in the [examples](https://developers.google.com/search/docs/monitor-debug/security/social-engineering/#example). In other cases, the host site does not contain any visible ads, but leads users to social engineering pages via pop-ups, pop-unders, or other types of redirection. In both cases, this type of embedded social engineering content will result in a policy violation for the host page.
...
See our [Help for Hacked Sites](https://web.dev/articles/hacked) if you believe that your site has been hacked.
...
<figure>
<img src="https://lh3.googleusercontent.com/M1marY2U0TpG5jlbdOE-ISvmUaoLErD03-95JxDdxD89VDuUmgmctDiOOMmKOzZxB2Q=w280" title="Deceptive popup intended to trick the user into installing malware" alt="Social engineering popup that tries to make the user install an unwanted application" />
<figcaption>Deceptive popup intended to trick the user into installing malware.</figcaption>
</figure>

<figure>
<img src="https://lh3.googleusercontent.com/Opsb7huiddG8az9vN9rF6Ds0I_QLsJpd_VVQfjElnB9hZNQxnDwO21YJBloBq8YAs4OB=w673" alt="Example of social engineering attempt claiming a browser update is required" />
<figcaption>Deceptive popup claiming to help the user update their browser</figcaption>
</figure>

<figure>
<img src="https://lh3.googleusercontent.com/uTWvxf7NR7alzT_VEF1wD31v3l6CeKG7M7nN4wpa-Z_nSGb5xsMUi19RTUTKQimqbu0=w577" alt="Fake Google login page" />
<figcaption aria-hidden="true">Fake Google login page</figcaption>
</figure>
...
<figure>
<img src="https://lh3.googleusercontent.com/DppbfyYk_wlh1FGF4yJC2JjngwUXWJ1byLiLcBC8XApJjf1Qw6JNdmKc9SO0EJ0XTBoQ=w320" alt="Deceptive ad claiming to be a media player update on the page" />
<figcaption>Deceptive popup claiming that the user's software is out of date.</figcaption>
</figure>

<figure>
<img src="https://lh3.googleusercontent.com/bIKFz8xmrKW5dS7TS40NVQRqoy0eN3GB6FsE2l5tCWGexueJSlgxoQYCiIafk8YWFg=w320" alt="Deceptive ad claiming to be an installer for a required component" />
<figcaption>Deceptive popup claiming to come from the FLV developer</figcaption>
</figure>

<figure>
<img src="https://lh3.googleusercontent.com/oSuub3M4dcqc_UD5F1pCpPQEG_--gDnpro8PKG0V9kEirLl3Q9WjZQXeaLbZkT192P6l=w320" alt="Deceptive ads claiming to be playback controller buttons on the host page" />
<figcaption>Ads masquerading as page action buttons.</figcaption>
</figure>

## Fixing the problem

If your site is flagged for containing social engineering (deceptive content), ensure that your page doesn't engage in any of the [practices](https://developers.google.com/search/docs/monitor-debug/security/social-engineering/#examples), and then follow these steps:
...
3.  **Check the third-party resources included in your site**. Ensure that any ads, images, or other embedded third-party resources on your site's pages are not deceptive.
    ...
    - Follow the [third-party service guidelines](https://developers.google.com/search/docs/monitor-debug/security/social-engineering/#third-party-guidelines) for any third-party services, such as payment services, that you use in your site.
...
[^google-social-engineering]: Google Search Central (2025). "Social engineering (phishing and deceptive sites)". *Google for Developers*. https://developers.google.com/search/docs/monitor-debug/security/social-engineering. Retrieved 2026-09-01.
