...
> Mirrored from the official Google Search Central documentation at [https://developers.google.com/search/docs/fundamentals/seo-starter-guide](https://developers.google.com/search/docs/fundamentals/seo-starter-guide). Page content, including any embedded figures, is authored by Google and was last updated by Google on 2025-12-10.[^google-seo-starter-guide]
...
The [Search Essentials](/essentials/overview.md) outline the most important elements of what makes your website eligible to appear on Google Search. While there's no guarantee that any particular site will be added to Google's index, sites that follow the **Search Essentials are more likely to show up in Google's search results**. SEO is about taking the next step and **working on improving your site's presence in Search**. This guide will walk you through some of the most common and effective improvements you can do on your site.
...
Before you actually do anything mentioned in this section, check if Google has already found your content (maybe you don't need to do anything!). Try searching on Google for your site with the [`site: search operator`](/monitor-debug/search-operators/all-search-site.md). If you see results pointing to your site, you're in the index. For example, a search for `site:wikipedia.org` returns [these results](https://www.google.com/search?q=site:wikipedia.org). If you don't see your site, check out the [technical requirements](/essentials/technical.md) to make sure there's nothing technically preventing your site from showing in Google Search, and then come back here.
...
Google learns breadcrumbs automatically based on the words in the URL, but you can also influence them with [structured data](/appearance/structured-data/breadcrumb.md) if you like a technical challenge. Try to include words in the URL that may be useful for users; for example:
...
The content in the `policies` directory seldomly changes, however the content in the `promotions` directory likely changes very often. Google can learn this information and crawl the different directories at different frequencies. To learn more about search-friendly site structures, check out our [guide for ecommerce sites](/specialty/ecommerce/help-google-understand-your-ecommerce-site-structure.md), for which a good URL structure is more important as they tend to be larger.

### Reduce duplicate content

Some websites show the same content under different URLs, which is called *[duplicate content](/crawling-indexing/canonicalization.md)*. Search engines choose a single URL (the *canonical* URL) to show users, per piece of content.

Having duplicate content on your site is not a violation of our spam policies, but it can be a bad user experience and search engines might waste crawling resources on URLs that you don't even care about. If you're feeling adventurous, it's worth figuring out if you can [specify a canonical version](/crawling-indexing/consolidate-duplicate-urls.md) for your pages. But if you don't canonicalize your URLs yourself, Google will try to automatically do it for you.
...
If you have multiple pages that have the same information, try setting up a [redirect](/crawling-indexing/301-redirects.md) from non-preferred URLs to a URL that best represents that information. If you can't redirect, use the [`rel="canonical"`](/crawling-indexing/consolidate-duplicate-urls.md) `link` element instead. But again, don't worry too much about this; search engines can generally figure this out for you on their own most of the time.
...
- **[The content is unique](/essentials/spam-policies.md)**: When you're writing new content, don't copy others' content in part or in its entirety: create the content yourself based on what you know about the topic. Don't just rehash what others already published.
...
- **The content is [helpful, reliable, and people-first](/fundamentals/creating-helpful-content.md):** Be sure that you're writing content that your readers will find helpful and reliable. For example, providing expert or experienced sources can help people understand your articles' expertise.
...
While ads are a part of the internet and are meant to be seen by users, don't let them become overly distracting or prevent your users from reading your content. For example, advertisements, or [interstitial pages](/appearance/avoid-intrusive-interstitials.md) (pages displayed before or after the content you're expecting) that make it difficult to use the website.
...
A typical Google Search results page consists of a [few different visual elements](/appearance/visual-elements-gallery.md) that you can influence to help users decide whether they should visit your site through those search results. In this section, we're focusing on the *title link* and the *snippet* because these are the more visually significant elements.
...
Alt text is a short, but descriptive piece of text that explains the relationship between the image and your content. It helps search engines understand what your image is about and the context of how your image relates to your page, so writing [good alt text](/appearance/google-images.md) is quite important. You can add this to your HTML with the `alt` attribute of the `img` element, or your CMS may have an easy way to specify a description for an image when you're uploading it to your site. Learn more about [how to write good alt text](/appearance/google-images.md), and how to add it to your images.
...
If your site is particularly video-focused, then continue reading about more things you can do to [optimize your videos for search engines](/appearance/video.md).
...
As with everything in life, you can overdo promoting your site and actually harm it: people may get fatigued of your promotions, and search engines may perceive some of the practices as [manipulation of search results](/essentials/spam-policies.md).
...
<dd>
          Google Search
          <a href="https://developers.google.com/search/blog/2009/09/google-does-not-use-keywords-meta-tag">doesn't use the keywords meta tag</a>.
        </dd>
<dt>
          Keyword stuffing
        </dt>
<dd>
          ...
          variations) is tiring for users, and <a href="/essentials/spam-policies.md">keyword stuffing is against Google's spam policies</a>.
        </dd>
<dt>
...
<p>When picking the name of your site, do what's
            ...
            <a href="/appearance/visual-elements-gallery.md">breadcrumbs</a>.
          </p>
<p>
            ...
            <a href="/specialty/international/managing-multi-regional-sites.md">SEO point of view</a>)
...
<dd>
          While <a href="/appearance/ranking-systems-guide.md">PageRank</a>
...
<dd>
          ...
          a manual action. <a href="/essentials/spam-policies.md">Copying others' content, however, is a different story.</a>
</dd>
<dt>
...
<dd>
<a href="/fundamentals/creating-helpful-content.md">No, it's not.</a>
</dd>
</dl>
</td>
</tr>
...
- **Get started with Search Console**: Setting up a Search Console account helps you monitor and optimize how your website performs on Google Search. Learn how to [set up your account and what reports to check out first](/monitor-debug/search-console-start.md).
- **Maintain your website's SEO over time**: Learn more about [managing your site's presence in the long term](/fundamentals/get-started.md), including more in-depth SEO tasks and scenarios, such as preparing for a site move, or managing a multi-lingual site.
- **Enhance how your site looks in Google Search results**: Valid [structured data](/appearance/structured-data/intro-structured-data.md) on your pages also makes your pages eligible for many special features in Google Search results, including review stars, carousels, and more. Explore the [gallery of search result types](/appearance/structured-data/search-gallery.md) that your page can be eligible for.
...
<td>
<ul>
<li><a href="https://developers.google.com/search/blog">Google Search Central blog</a>: Get the latest information from our
...
<li>Google Search Central on <a href="https://www.linkedin.com/showcase/googlesearchcentral/">LinkedIn</a> and <a href="https://twitter.com/googlesearchc">X (Twitter)</a>:
...
<td>
<ul>
<li><a href="https://support.google.com/webmasters/community">Google Search Central Help Forum</a>:
          ...
          <a href="https://productexperts.withgoogle.com/">Product Experts</a> and
          occasionally Googlers.
        </li>
<li><a href="https://www.youtube.com/c/GoogleSearchCentral">Google Search Central YouTube Channel</a>:
...
[^google-seo-starter-guide]: Google Search Central (2025). "Search Engine Optimization (SEO) Starter Guide". *Google for Developers*. https://developers.google.com/search/docs/fundamentals/seo-starter-guide. Retrieved 2026-09-01.
